...
const MyProjects = ({ theme }) => {
  ...
  const ProjectsArray = [
    ...
    },
    {
      id: 2,
      projectImage: (
        <img src={redProject} alt="" className="image-fluid project-image" />
      ),
      ProjectDetails: [
        {
          projectTitle: "Login Signup Project",
          ProjectInfo:
            " Created a site of Signup and Login using Redux and Redux toolkit Signup and Login are auntentication based and condition based. Example if you register successfully and login with wrong info it will get you error.",
          Technologies: "React, Redux, MUI, HTML5, CSS3 ",
          Industry: "Web Development",
          URL: "https://6429d544fe1ad845d5308587--delicate-granita-5e9ca8.netlify.app/",
          image1: (
            <img className="image-fluid w-100 " src={redProject} alt="" />
          ),
...

    {
      id: 3,
      projectImage: (
        <img src={restaurant} alt="" className="image-fluid project-image" />
      ),
      ProjectDetails: [
        {
          projectTitle: "RESTUARANT PROJECT",
          ProjectInfo:
            "Restaurant website this was my first project after learning React and Redux In this web simply we can add food items from admin side food item can be add cart or favorites list for database i use firebase.",
          Technologies: "React, Redux, FIREBASE MUI, HTML5, CSS3 ",
          Industry: "Web Development",
          URL: "https://heartfelt-macaron-24478b.netlify.app/",
          image1: (
            <img className="image-fluid w-100 " src={restaurant} alt="" />
          ),
    ...
    },
    {
      id: 4,
      projectImage: (
        <img src={menu} alt="" className="image-fluid project-image" />
      ),
      ProjectDetails: [
        {
    ...
    },
    {
      id: 6,
      projectImage: (
        <img src={todo} alt="" className="image-fluid project-image" />
      ),
      ProjectDetails: [
        {
          projectTitle: "TODO PROJECT",
          ProjectInfo:
            'This is a TODO LIST App In which you can 1-Add Task 2-Update Task 3-Delete Task And funfact you can not add same task again it will show the alert "Duplicate Task Found"',
    ...
    },
    {
      id: 5,
      projectImage: (
        <img src={music} alt="" className="image-fluid project-image" />
      ),
      ProjectDetails: [
        {
          projectTitle: "MUSIC PROJECT",
          ProjectInfo:
            "Developed an elegant React.js Music Application. A small Music Application using Api of Shazam Core",
                      ...
                      <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12 mt-4">
                          ...
                          <div className=" mt-3">
                            <ul className="silk-dots d-flex  justify-content-center">
                              <li
                                className={
                                  currentIndex === 0 ? "mx-3 li-btn" : "mx-3"
                                }
                                onClick={handleSlider}
                              ></li>
                              <li
                                className={
                                  currentIndex === 1 ? "mx-3 li-btn" : "mx-3"
                                }
                                onClick={handleSlider1}
                              ></li>
                              <li
                                className={
                                  currentIndex === 2 ? "mx-3 li-btn" : "mx-3"
                                }
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12">
                          ...
                          <div className="d-flex mt-4 border-bottom">
                            <h5>Technologies:</h5>
                            <p className="mx-2 text-uppercase mt-1">
                              {item.Technologies}
                            </p>
                          </div>
                          <div className="d-flex mt-4  border-bottom">
